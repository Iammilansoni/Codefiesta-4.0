...
export default defineConfig(({ mode }) => ({
  ...
  // Optimize dependencies for performance - AGGRESSIVE PRELOADING
  optimizeDeps: {
    include: [
      'react', 
      'react-dom',
  ...
  // Server configuration for development with performance focus
  server: {
    port: 5173,
    host: true,
    open: false,
    hmr: {
      overlay: true,
      port: 24678 // Separate HMR port for better performance
    },
